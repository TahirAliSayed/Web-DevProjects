                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="top-bar-item">
                                    <div class="usricon2"><img src="../Assets/File/Workshop/mechanic.png" alt="user dp"></div>
                            ...
                            <div class="col-4">
                                <div class="top-bar-item">
                                    ...
                                    <div class="top-bar-text">
                                        <h3>Hello <?php echo $_SESSION["mname"]; ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            <a href="HomePage.php" class="nav-item nav-link active" aria-expanded="false">Home</a>
                            <a href="ViewAssignedWork.php" class="nav-item nav-link"aria-expanded="false">Work</a>
