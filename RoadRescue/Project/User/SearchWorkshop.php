...
<a style="
    ...
    href="SendRequest.php?ch=<?php echo $row['workshop_id']; ?>&mail=<?php echo $row['workshop_email']; ?>" 
    onmouseover="this.style.background='#E81C2E'; this.style.color='#ffffff'; this.style.boxShadow='0 4px 10px rgba(232, 28, 46, 0.5)';"
    onmouseout="this.style.background='#ffffff'; this.style.color='#202C45'; this.style.boxShadow='inset 0 0 0 0 #E81C2E';">
    Request
</a>
<br />
