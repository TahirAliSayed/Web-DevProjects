<br><br><br>
        ...
        <div class="footer">
            ...
            <div class="container copyright">
                <p>&copy; <a href="http://localhost/RoadRescue/RoadRescue/Project/User/HomePage.php">2024 RoadRescue</a>, All Right Reserved. Designed By <a href=http://localhost/RoadRescue/RoadRescue/Project/User/HomePage.php>RoadRescue</a></p>
            </div>
        </div>
        <!-- Footer End -->
