...
{
    $a = "update tbl_request set request_status='6' where request_id='".$_SESSION["rid"]."'";
    if($conn->query($a))
    {
        // Store payment details in session for the invoice
        $_SESSION['payment_details'] = [
            'name' => $_POST['txtname'] . ' ' . $_POST['txtnname'],
            'email' => $_POST['txtemail'],
            'card_type' => (isset($_POST['rdbpay']) && $_POST['rdbpay'] == 'cc') ? 'Credit Card' : 'Debit Card',
            'card_last4' => substr($_POST['txtcardno'], -4),
            'date' => date('Y-m-d H:i:s'),
            'amount' => 'XX.XX' // Replace with actual amount from your database
        ];
	...
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				...
				<div class="input-box">
					<input class="name" type="text" name="txtnname" id="txtnname" placeholder="Second Name" required autocomplete="off">
					<i class="fa fa-user icon" aria-hidden="true"></i>
				</div>
			</div>
			<div class="input-group">
