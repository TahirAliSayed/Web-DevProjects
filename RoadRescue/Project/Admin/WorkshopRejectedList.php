...
if(isset($_GET["ch"]))
	...
	if($conn->query($up))
	{
		?>
		<script>
		window.location='WorkshopRejectedList.php';
        </script>
		<?php
...
<title>Workshop Rejected List</title>
</head>
...
$selqry = "select * from tbl_workshop w inner join tbl_location l on w.workshop_location=l.location_id inner join tbl_place p on p.place_id=l.place_id inner join tbl_district d on d.district_id=p.district_id where workshop_status='2'"; 
...
?>
		<tr align="center">
           ...
           <img src="../Assets/File/Workshop/<?php echo $row["workshop_proof"];?>" width="50" height="50" />
            ...
            <td align="center">
             <a href="WorkshopRejectedList.php?ch=<?php echo $row["workshop_id"];?>">Accept</a>
             </td>
            </tr>
        <?php
}
