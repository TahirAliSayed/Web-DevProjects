        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
				...
				include('../Assets/Connection/Connection.php');
				 ...
				 $l=0;
			 		 ...
			 		 $selQry = "select * from tbl_product ";
					    ...
					    $rs = $conn->query($selQry);
                   		...
                   		while ($data = $rs->fetch_assoc()) 
                     		...
                     		$i++;
				   			...
				   			$sel="select COALESCE(sum(cart_qty),0) as qty from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id where product_id='".$data["product_id"]."'";
						...
						{
							$sel = $sel." and booking_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
						}
			...
			?>
              <tr align="center">
                 ...
                 <td align="center"><?php  echo  $data1["qty"];?></td>
