                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="top-bar-item">
                                    <div class="usricon"><img src="../Assets/File/Workshop/workshop.png" alt="user dp"></div>
                            ...
                            <div class="col-4">
                                <div class="top-bar-item">
                                    ...
                                    <div class="top-bar-text">
                                        <h3>Hello <?php echo $_SESSION["wname"]; ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                   ...
                   <!-- <a href="../Assets/Templates/Main/#" class="navbar-brand">MENU</a>-->
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="MechanicRegistration.php" class="nav-item nav-link ">Mechanic</a>
