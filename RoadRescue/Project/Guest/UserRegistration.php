...
if(isset($_POST["btnsave"]))
{
    ...
    $checkEmailQuery = "SELECT * FROM tbl_user WHERE user_email = '$email'";
    ...
    if ($emailResult->num_rows > 0) {
        ...
        $insqry = "INSERT INTO tbl_user(user_name, user_contact, user_email, user_gender, user_address, user_dob, user_password, place_id, user_photo, user_doj) 
                   VALUES ('$name', '$contact', '$email', '$gender', '$address', '$dob', '$password', '$place', '$photo', CURDATE())";
...
<tr>
  ...
  <tr>
    <td colspan="2"><div align="center">
      <input type="submit" name="btnsave" id="btnsave" value="Submit" onclick="sendEmail()"/>&nbsp;&nbsp;&nbsp;
