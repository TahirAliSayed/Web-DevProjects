<br><br><br>
        ...
        <div class="footer">
            ...
            <p>&copy; <a href="http://localhost/RoadRescue/RoadRescue/Project/Workshop/HomePage.php">2024 RoadRescue</a>, All Right Reserved. Designed By <a href="http://localhost/RoadRescue/RoadRescue/Project/Workshop/HomePage.php">RoadRescue</a></p>
            </div>
        </div>
        <!-- Footer End -->
